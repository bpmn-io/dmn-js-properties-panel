import EntryFieldDescription from 'lib/factory/EntryFieldDescription';
...
describe('factory/EntryFieldDescription', function() {
  ...
  describe('escaping', function() {
    ...
    it('should escape HTML', function() {
      ...
      // then
      expect(html).to.eql('<div class="dpp-field-description">&lt;html /&gt;</div>');
    });
    ...
    it('should preserve plain <a href>', function() {
      ...
      // then
      expect(html).to.eql(
        '<div class="dpp-field-description">' +
    ...
    it('should handle special HTML chars in markdown link', function() {
      ...
      expect(html).to.eql(
        '<div class="dpp-field-description">' +
          'Hallo ' +
          '<a href="http://foo=%22%3E" target="_blank">' +
            'YOU' +
          '</a>' +
        '</div>'
      );
