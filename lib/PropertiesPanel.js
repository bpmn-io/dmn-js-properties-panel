...
PropertiesPanel.prototype._init = function(config) {
  ...
  this._container = domify('<div class="dpp-properties-panel"></div>');
...
PropertiesPanel.prototype._createPanel = function(element, tabs) {
  ...
  forEach(tabs, function(tab, tabIndex) {
    ...
    var tabNode = domify('<div class="dpp-properties-tab" data-tab="' + tab.id + '"></div>'),
    ...
    forEach(groups, function(group) {
      ...
      forEach(group.entries, function(entry) {
        ...
        var entryNode = domify('<div class="dpp-properties-entry" data-entry="' + entry.id + '"></div>');
